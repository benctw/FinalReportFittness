...
def handle_something(event):
    ...
    if event.message.type=='text':
        ...
        if '健身菜單推薦' in recrive_text:
            ...
            messages=[]
            messages.append(ImageSendMessage(original_content_url='https://www.f1-recreation.com.tw/images/com_hikashop/upload/hs-be.jpg', preview_image_url='https://www.f1-recreation.com.tw/images/com_hikashop/upload/hs-be.jpg'))
